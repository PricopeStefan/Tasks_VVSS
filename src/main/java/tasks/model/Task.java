...
/**
 * class that encapsulates a task object with crud get methods
 */
public class Task implements Serializable {
    ...
    //CHANGED 12.03.2020 - sonarlint recommends deleting the clone function because it is dangerous
}
