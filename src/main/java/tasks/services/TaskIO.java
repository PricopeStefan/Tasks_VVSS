...
public class TaskIO {
    ...
    public static void write(TaskList tasks, OutputStream out) throws IOException {
        //CHANGED ON 12.03.2020 - from a declaration and a try changed to a try with resources(safer and more efficient)
    ...
    public static void writeBinary(TaskList tasks, File file)throws IOException{
        ...
        try (FileOutputStream fos = new FileOutputStream(file)) {
            ...
            log.error("IO exception reading or writing file 1");
        }
    }
    ...
    public static void readBinary(TaskList tasks, File file) throws IOException{
        ...
        try (FileInputStream fis = new FileInputStream(file)) {
            ...
            log.error("IO exception reading or writing file 2");
        }
    }
    ...
    public static void writeText(TaskList tasks, File file) throws IOException {
        ...
        try (FileWriter fileWriter = new FileWriter(file)) {
            ...
            log.error("IO exception reading or writing file 3");
        }
    ...
    public static void rewriteFile(ObservableList<Task> tasksList) {
        ...
        try {
            ...
            log.error("IO exception reading or writing file 4");
        }
    }
}
